    ...
    <style>
        * {
        ...
        @media (max-width:660px) {
            ...
            .row-1 .column-1 .block-3.button_block div,
                                                                    ...
                                                                    <table border="0" cellpadding="0"
                                                                        ...
                                                                        <tr>
                                                                            <td class="divider_inner"
                                                                                style="font-size: 1px; line-height: 1px; border-top: 2px solid #E2E2E2;">
                                                                                <span> </span>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div align="left" class="alignment">
                                                                    <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" style="height:34px;width:109px;v-text-anchor:middle;" arcsize="148%" stroke="false" fillcolor="#e0f6fa"><w:anchorlock/><v:textbox inset="0px,0px,0px,0px"><center style="color:#00b6d6; font-family:Arial, sans-serif; font-size:12px"><![endif]-->
                                                                    <div
                                                                        style="text-decoration:none;display:inline-block;color:#00b6d6;background-color:#e0f6fa;border-radius:50px;width:auto;border-top:0px solid transparent;font-weight:700;border-right:0px solid transparent;border-bottom:0px solid transparent;border-left:0px solid transparent;padding-top:5px;padding-bottom:5px;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:12px;text-align:center;mso-border-alt:none;word-break:keep-all;">
                                                                        <span
                                                                            style="padding-left:20px;padding-right:20px;font-size:12px;display:inline-block;letter-spacing:normal;"><span
                                                                                dir="ltr"
                                                                                style="word-break: break-word; line-height: 24px;">Order
                                                                                #{{ $order_id }}</span></span>
                                                                    </div>
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <h1
                                                                    ...
                                                                    One more step to<br />complete your order</h1>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p style="margin: 0;">Hi
                                                                        <strong>{{ '@' }}{{ $order_buyer_name }},</strong>
                                                                    </p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p style="margin: 0;">Just to let you know - we’ve
                                                                        received your order #{{ $order_id }} and
                                                                        below are the
                                                                        details :</p>
                                                                </div>
                                                            </td>
                            ...
                            <tr>
                                <td>
                                    <table align="center" border="0" cellpadding="0" cellspacing="0"
                                        ...
                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-radius: 0; color: #000000; width: 640px;"
                                        width="640">
                                        <tbody>
                                            <tr>
                                                <td class="column column-1"
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <div
                                                                    style="color:#000000;direction:ltr;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:14px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:16.8px;">
                                                                    <p style="margin: 0;">Service ordered :</p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                style="padding-bottom:10px;padding-top:10px;">
                                                                <div
                                                                    style="color:#9f9f9f;direction:ltr;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:14px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:right;mso-line-height-alt:16.8px;">
                                            ...
                                            <tr>
                                                <td class="column column-1"
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                style="padding-bottom:5px;padding-left:20px;padding-right:10px;padding-top:5px;">
                                                                <div
                                                                    style="color:#000000;direction:ltr;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:19px;font-weight:700;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:22.8px;">
                                                                    <p style="margin: 0;">{{ $order_category }} Service
                                                                    </p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                ...
                                                <td class="column column-2"
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                style="padding-bottom:10px;padding-left:10px;padding-top:10px;">
                                                                <div
                                                                    style="color:#000000;direction:ltr;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:19px;font-weight:700;letter-spacing:0px;line-height:120%;text-align:right;mso-line-height-alt:22.8px;">
                                                                    <p style="margin: 0;">${{ $order_sub_total }}</p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div align="center" class="alignment">
                                                                    <table border="0" cellpadding="0"
                                                                        ...
                                                                        <tr>
                                                                            <td class="divider_inner"
                                                                                style="font-size: 1px; line-height: 1px; border-top: 2px solid #E7E7E7;">
                                                                                <span> </span>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                style="padding-bottom:10px;padding-left:10px;padding-top:10px;">
                                                                <div
                                                                    style="color:#000000;direction:ltr;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:15px;font-weight:700;letter-spacing:0px;line-height:120%;text-align:right;mso-line-height-alt:18px;">
                                                                    <p style="margin: 0;">${{ $order_sub_total }}</p>
                                                                </div>
                                                            </td>
                                                        </tr>
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <table align="center" border="0" cellpadding="0" cellspacing="0"
                                        class="row-content" role="presentation"
                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-size: auto; border-radius: 0; color: #000000; width: 640px;"
                                        width="640">
                                        <tbody>
                                            <tr>
                                                <td class="column column-1"
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                style="padding-bottom:10px;padding-left:20px;padding-right:10px;padding-top:10px;">
                                                                <div
                                                                    style="color:#000000;direction:ltr;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:15px;font-weight:700;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:18px;">
                                                ...
                                                <td class="column column-2"
                                                    ...
                                                    <table border="0" cellpadding="10" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div
                                                                    style="color:#000000;direction:ltr;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:23px;font-weight:700;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:27.599999999999998px;">
                                                                    <p style="margin: 0;">
                                                                        ${{ $order_sub_total + $order_tax }}</p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                ...
                                                <td class="column column-1"
                                                    ...
                                                    <table border="0" cellpadding="10" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div
                                                                    style="color:#404040;direction:ltr;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:15px;font-weight:700;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:18px;">
                                                                    <p style="margin: 0;">{{ $order_buyer_address }}
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    ...
                                                    <table border="0" cellpadding="10" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div
                                                                    style="color:#404040;direction:ltr;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:15px;font-weight:700;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:18px;">
                                                                    <p style="margin: 0;">{{ $order_seller_address }}
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p style="margin: 0;">If you have any questions or
                                                                        concerns please contact our <strong><a
                                                                                href="https://hedgecare.ca"
                                                                                rel="noopener"
                                                                                style="text-decoration: none; color: #0b2a59;"
