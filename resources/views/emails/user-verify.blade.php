...
<head>
    <title>Email Confirmation Register</title>
    ...
    <style>
        * {
        ...
        @media (max-width:660px) {
            ...
            .row-2 .column-1 .block-1.button_block td.pad {
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p style="margin: 0;">Click the button below to
                                                                        verify your account registration.<br />Or, if
                                                                        this wasn’t you, simply ignore this email.</p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                            ...
                                            <tr>
                                                <td class="column column-1"
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                style="padding-bottom:45px;padding-top:10px;text-align:left;">
                                                                <div align="left" class="alignment">
                                                                    <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" style="height:40px;width:158px;v-text-anchor:middle;" arcsize="125%" stroke="false" fillcolor="#0b2a59"><w:anchorlock/><v:textbox inset="0px,0px,0px,0px"><center style="color:#ffffff; font-family:Arial, sans-serif; font-size:15px"><![endif]-->
                                                                    <div
